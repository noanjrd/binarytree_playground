...
export function PostorderExplainations({ setInputText }: ExplainationsGroupProps) {
    ...
    return (
        <>
            <div onScroll={() => setVisibleArrow(false)} className='relative card  px-5 py-5  overflow-y-auto  scrollbar-none max-h-[66vh] flex justify-center'
                style={{
                ...
                <div className='relative'>
                    ...
                    {/* <p className='explain-text mt-3 '>Mnemonic code : <code className='code font-medium'>left, right, node</code> </p> */}
